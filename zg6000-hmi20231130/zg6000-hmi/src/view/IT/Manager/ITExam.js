...
import { ITDetailedInfo } from './ITDetailedInfoManager';
import constFn from '../../../util';
import constVar from '../../../constant';

export default class ITExam extends Component {

    constructor(props) {
        super(props);
        this.id = props.id;//任务ID
                ...
                <div style={{ display: "flex", overflow: "auto", height: "100%" }}>
                    ...
                    <div style={{ flex: 2, display: "flex", flexDirection: "column", height: "100%", overflow: "auto" }}>
                        <Descriptions column={1} bordered size="small" className='sys-bg'>
                            <Descriptions.Item label="名称">{constFn.reNullStr(this.state.ITInfo?.head?.name)}</Descriptions.Item>
