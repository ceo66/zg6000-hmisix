...
export default class CreateITByTypical extends PureComponent {
                                    ...
                                    verifyPowerParam: {
                                        ...this.state.verifyPowerParam, ...{
                                            ...
                                            callback: (userID, userName) => {
                                                constFn.postRequestAJAX(constVar.url.app.op.ITCreateTypical, {
    ...
    getITTaskList() {
        let condition = "subsystemID = '" + this.moduleContext.subsystemID + "' AND taskTypeID = '" + constVar.task.type.ZG_TT_IT + "' ";
        ...
        constFn.postRequestAJAX(constVar.url.app.op.ITTypicalList, {
            clientID: this.sysContext.clientUnique,
            time: this.sysContext.serverTime,
            params: {
                condition: condition,
        ...
        return (
            <>
                ...
                <Modal
                    ...
                    title={<div style={{ textAlign: "center" }}>创建典型巡检任务</div>}
