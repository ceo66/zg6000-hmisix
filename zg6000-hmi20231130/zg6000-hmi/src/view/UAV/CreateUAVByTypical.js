...
export default class CreateUAVByTypical extends PureComponent {
    ...
    getUAVTaskList() {
        let condition = "subsystemID = '" + this.moduleContext.subsystemID + "' AND taskTypeID = '" +  constVar.task.type.ZG_TT_IT_UAV + "'";
